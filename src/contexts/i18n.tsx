...
const en: Dict = {
  ...
  'landing.shortcuts.desc.shiftSize': 'Grow / shrink the camera overlay',
  'landing.shortcuts.key.ctrl0': 'Ctrl + 0',
  'landing.shortcuts.desc.ctrl0': 'Reset framing',
  'landing.shortcuts.key.e': 'E',
  'landing.shortcuts.desc.e': 'Toggle camera on / off',
  'landing.shortcuts.key.d': 'D',
  'landing.shortcuts.desc.d': 'Toggle microphone on / off',
  'landing.shortcuts.key.space': 'Space',
  'landing.shortcuts.desc.space': 'Teleprompter play / pause (auto mode)',
  'landing.shortcuts.key.pageUpDown': 'PageUp / PageDown',
  'landing.shortcuts.desc.pageUpDown': 'Teleprompter previous / next page',
  'landing.shortcuts.key.bracket': '[ / ]',
  'landing.shortcuts.desc.bracket':
    'Teleprompter slower / faster (auto mode only)',
...
const zh: Dict = {
  ...
  'landing.shortcuts.key.shiftSize': 'Shift + = / -',
  'landing.shortcuts.desc.shiftSize': '增大 / 缩小摄像头',
  'landing.shortcuts.key.ctrl0': 'Ctrl + 0',
  'landing.shortcuts.desc.ctrl0': '重置取景',
  'landing.shortcuts.key.e': 'E',
  'landing.shortcuts.desc.e': '切换摄像头开关',
  'landing.shortcuts.key.d': 'D',
  'landing.shortcuts.desc.d': '切换麦克风开关',
  'landing.shortcuts.key.space': '空格',
  'landing.shortcuts.desc.space': '提词器播放 / 暂停（自动模式）',
  'landing.shortcuts.key.pageUpDown': 'PageUp / PageDown',
  'landing.shortcuts.desc.pageUpDown': '提词器上一段 / 下一段',
  'landing.shortcuts.key.bracket': '[ / ]',
  'landing.shortcuts.desc.bracket': '提词器减速 / 加速（仅自动模式）',
  'landing.shortcuts.key.home': 'Home',
